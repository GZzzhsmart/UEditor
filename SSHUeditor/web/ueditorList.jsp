            ...
            <c:forEach items="${ueditorList}" var="s">
                <tr class="text-c">
                    ...
                    <td class="f-14 td-manage">
                        <a style="text-decoration:none" class="ml-5" onClick="article_edit('资讯编辑','<%=path%>/ueditor/find?ueditor.id=${s.id}','800','')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
...
<script type="text/javascript">
    ...
    function article_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                type: 'POST',
                url: '<%=path%>/ueditor/delete?ueditor.id='+id,
                dataType: 'text',
