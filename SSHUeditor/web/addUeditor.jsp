    ...
    <form class="form form-horizontal"  id="form-member-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="title" name="ueditor.title">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>资讯内容：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea   style="width:566px;height:300px"  id="content" name="ueditor.content"></textarea>
            </div>
        </div>
    ...
    $(function(){
        $("#form-member-add").validate({
            ...
            submitHandler:function(form){
                //$(form).ajaxSubmit();
                $.post(
                    "<%=path%>/ueditor/add",$("#form-member-add").serialize(),
                    function(data){
                    },
                    "json"
                );
