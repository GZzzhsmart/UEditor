...
public class ContactWriter {
    ...
    public void writeContact(String path) {
        ...
        studentList.add(new Student(1, "张三", "男", "18720865791"));
        studentList.add(new Student(2, "李四", "男", "17370134037"));
        studentList.add(new Student(3, "王五", "男", "15674099439"));
        studentList.add(new Student(4, "小丽", "女", "13177619167"));
